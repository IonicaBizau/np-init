...
:bulb: **ProTip**: You can install the [cli version of this module](https://github.com/IonicaBizau/np-init-cli) by running `npm install --global np-init-cli` (or `yarn global add np-init-cli`).
